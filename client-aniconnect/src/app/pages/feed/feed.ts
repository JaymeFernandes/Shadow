...
import { PostPlaceholder } from './components/post-placeholder/post-placeholder';


@Component({
  selector: 'app-feed',
  standalone: true,
  imports: [ Post, PostPlaceholder ],
...
1. **Ichigo Kurosaki**
    - Protagonista, meio humano, meio Shinigami, meio tudo.
2. **Rukia Kuchiki**
    - Shinigami que dá seus poderes a Ichigo.
3. **Uryuu Ishida**
    - Quincy, arqueiro espiritual.
4. **Orihime Inoue**
    - Tem poderes de rejeitar eventos, quase como "reverter o tempo".
5. **Yasutora 'Chad' Sado**
    - Força bruta com braços espirituais.
